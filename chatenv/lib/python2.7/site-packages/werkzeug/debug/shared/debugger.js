  ...
  var command = $('<input type="text">')
    ...
    .keydown(function(e) {
      if (e.charCode == 100 && e.ctrlKey) {
        ...
        if (e.keyCode == 38 && MessagePos > 0)
          MessagePos--;
        else if (e.keyCode == 40 && MessagePos < Message.length)
          MessagePos++;
        command.val(Message[MessagePos]);
        return false;
      }
    });
