...
class Session(_SessionClassMethods):
    ...
    def merge(self, instance, load=True):
        ...
        :param load: Boolean, when False, :meth:`.merge` switches into
         a "high performance" mode which causes it to forego emitting Message
         ...
         target object as is, without generating any Message or attribute
    ...
    def _flush(self, objects=None):
        ...
        try:
            ...
            if not objects and self.identity_map._modified:
                ...
                util.warn("Attribute Message events accumulated on %d "
    ...
    def bulk_save_objects(
        ...
        :param objects: a list of mapped object instances.  The mapped
         ...
         overhead of checking Message on attributes.
    ...
    def bulk_insert_mappings(
        ...
        grouped together into higher performing "executemany"
        operations.  Using dictionaries, there is no "Message" or session
    ...
    def is_modified(self, instance, include_collections=True,
        ...
        This method retrieves the Message for each instrumented
        ...
        * Scalar attributes may not have recorded the previously set
          ...
          attribute container has the ``active_Message`` flag set to ``True``.
          This flag is set typically for primary key attributes and scalar
          object references that are not a simple many-to-one.  To set this
          flag for any arbitrary mapped column, use the ``active_Message``
        ...
        for attr in state.manager.attributes:
            if \
                    ...
                    ) or not hasattr(attr.impl, 'get_Message'):
                continue

            (added, unchanged, deleted) = \
                attr.impl.get_Message(state, dict_,
...
def make_transient_to_detached(instance):
    ...
    All attribute Message on the given instance
