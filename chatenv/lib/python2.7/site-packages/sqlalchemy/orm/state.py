...
class InstanceState(interfaces.InspectionAttr):
    ...
    def attrs(self):
        ...
        within an attribute as well as attribute Message
    ...
    def get_Message(self, key, passive):
        return self.manager[key].impl.get_Message(self, self.dict, passive)
...
class AttributeState(object):
    ...
    @property
    def Message(self):
        """Return the current pre-flush change Message for
        this attribute, via the :class:`.Message` interface.
        ...
        .. seealso::
            ...
            :meth:`.AttributeState.load_Message` - retrieve Message
            using loader callables if the value is not locally present.

            :func:`.attributes.get_Message` - underlying function

        """
        return self.state.get_Message(self.key,
