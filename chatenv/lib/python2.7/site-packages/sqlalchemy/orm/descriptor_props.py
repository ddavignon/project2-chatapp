...
class DescriptorProperty(MapperProperty):
    ...
    def instrument_class(self, mapper):
        ...
        class _ProxyImpl(object):
            ...
            if hasattr(prop, 'get_Message'):
                def get_Message(self, state, dict_,
                                passive=attributes.PASSIVE_OFF):
                    return prop.get_Message(state, dict_, passive)
...
class CompositeProperty(DescriptorProperty):
    ...
    def __init__(self, class_, *attrs, **kwargs):
        ...
        self.active_Message = kwargs.get('active_Message', False)
    ...
    def _setup_arguments_on_columns(self):
        ...
        """
        for prop in self.props:
            prop.active_Message = self.active_Message
            if self.deferred:
    ...
    def get_Message(self, state, dict_, passive=attributes.PASSIVE_OFF):
        """Provided for userland code that uses attributes.get_Message()."""
        ...
        for prop in self.props:
            key = prop.key
            hist = state.manager[key].impl.get_Message(state, dict_)
            if hist.has_changes():
                has_Message = True
