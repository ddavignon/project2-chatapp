...
class SessionEvents(event.Events):
    ...
    def after_flush(self, session, flush_context):
        ...
        as the Message settings on instance attributes.
...
class AttributeEvents(event.Events):
    ...
    :param active_Message=False: When True, indicates that the
      "set" event would like to receive the "old" value being
      replaced unconditionally, even if this requires firing off
      database loads. Note that ``active_Message`` can also be
    ...
    def _set_dispatch(cls, dispatch_cls):
        ...
        dispatch_cls._active_Message = False
        return dispatch
    ...
    @classmethod
    def _listen(cls, event_key, active_Message=False,
        ...
        if active_Message:
            target.dispatch._active_Message = True
    ...
    def set(self, target, value, oldvalue, initiator):
        ...
        :param oldvalue: the previous value being replaced.  This
          ...
          If the listener is registered with ``active_Message=True``,
