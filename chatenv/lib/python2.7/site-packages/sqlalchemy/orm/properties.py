...
class ColumnProperty(StrategizedProperty):
    ...
    __slots__ = (
        ...
        'active_Message', 'expire_on_flush', 'info', 'doc',
    ...
    def __init__(self, *columns, **kwargs):
        ...
        :param active_Message=False:
          ...
          already loaded. Normally, Message tracking logic for
          simple non-primary-key scalar values only needs to be
          aware of the "new" value in order to perform a flush. This
          flag is available for applications that make use of
          :func:`.attributes.get_Message` or :meth:`.Session.is_modified`
        ...
        self.active_Message = kwargs.pop('active_Message', False)
